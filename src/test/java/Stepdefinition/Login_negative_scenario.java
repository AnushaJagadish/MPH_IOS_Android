...
public class Login_negative_scenario extends Generic_functions{
	...
	public static void invalid_phoneno_and_valid_password() throws Exception {
		try {
			page_wait(3000);
			click("login_phone_number");
			...
			e.printStackTrace();
			takeScreenShot("login_negative_invalid_phoneno_and_valid_password");
		}
	}
	...
	public static void invalid_password() throws InterruptedException, Exception {
		try {
			page_wait(5000);
			click("login_phone_number");
			driver.findElement(By.xpath(OR_reader("login_phone_number"))).sendKeys(td_reader("login_phone_number",0));
			...
			e.printStackTrace();
			takeScreenShot("login_negative_invalid_password");
		}
	}
