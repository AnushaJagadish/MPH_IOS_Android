...
public class Utilities_negative_scenario extends Generic_functions{
    ...
    public static void open_App() throws Exception {
        try {
            ...
            e.printStackTrace();
            takeScreenShot("Utilities_negative_open_App");
        }
    }
    ...
    public static void clicks_utilities() throws Exception {
        try {
            ...
            e.printStackTrace();
            takeScreenShot("Utilities_negative_clicks_utilities");
        }
    }
...
// TC001_Validate_leaving_fields_blank_add_card_page
    ...
    public static void click_Utilities_wallet() throws Exception {
        try {
            ...
            e.printStackTrace();
            takeScreenShot("Utilities_negative_click_Utilities_wallet");
        }
    }
    ...
    public static void click_add_card() throws Exception {
        ...
        click("utilities_add_debit_credit_card");}
            ...
            e.printStackTrace();
            takeScreenShot("Utilities_negative_click_add_card");
        }
    }
    ...
    public static void invalid_details_add_card() throws Exception {
        ...
        takeScreenShot("Utilities_negative_invalid_details_add_card");}
    }

    @Then("Validate message on entering invalid details on add card page")
    public static void validate_invalid_details_add_card() throws Exception {
        try{
        ...
        click("back_button");
            ...
            e.printStackTrace();
            takeScreenShot("Utilities_negative_validate_invalid_details_add_card");
        }
    }
...
//TC003_Validate message on leaving fields blank in the Add Bank page
    ...
    public static void click_add_bank() throws Exception {
        try {
            ...
            e.printStackTrace();
            takeScreenShot("Utilities_negative_click_add_bank");
        }
    }
    ...
    public static void leave_field_blank_add_bank() throws Exception {
        try {
            ...
            e.printStackTrace();
            takeScreenShot("Utilities_negative_leave_field_blank_add_bank");
        }
    }

    @And("Validate message on leaving fields blank in Add Bank page")
    public static void blank_add_bank() throws Exception {
        try{
            page_wait(4000);
            ...
            takeScreenShot("Utilities_negative_blank_add_bank");}
    }
//TC004_Validate that user gets validation message on entering invalid details in the Add Bank page
    ...
    public static void invalid_details_AddBank_page() throws Exception {
        try{
            text = driver.findElement(By.xpath(OR_reader("utilities_account_holder_name_valid_msg_two"))).getText();
            ...
            e.printStackTrace();
            takeScreenShot("Utilities_negative_invalid_details_AddBank_page");
        }
    }
...
//        page_wait(2000);
            ...
            e.printStackTrace();
            takeScreenShot("Utilities_negative_click_award_points");
        }
    }
...
//            click("utilities_back");
            ...
            e.printStackTrace(); 
            takeScreenShot("Utilities_negative_Validate_award_points_page");
        }
    }
...
//            click("utilities_idcard");
        	...
        	e.printStackTrace();
        takeScreenShot("Utilities_negative_click_ID_card");}
    }
...
//            Assert.assertEquals(true,value);
        click("utilities_ok_button");
            ...
            takeScreenShot("Utilities_negative_verify_ID_card");}
    }
...
//            click("utilities_upload");
            ...
            takeScreenShot("Utilities_negative_click_upload");}
    }
...
//            logout();
            ...
            takeScreenShot("Utilities_negative_verify_upload");}
    }
