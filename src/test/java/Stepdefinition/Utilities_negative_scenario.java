...
public class Utilities_negative_scenario extends Generic_functions{
	...
	public static void clicks_utilities() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("utilities_neagtive_clicks_utilities");
		}
	}
	...
	public static void invalid_details_add_card() throws Exception {
		try{
			...
			e.printStackTrace();
			takeScreenShot("utilities_neagtive_invalid_details_add_card");}
	}

	@Then("Validate message on entering invalid details on add card page")
	public static void invalid_details_add_card_message() throws Exception {
		...
		try{
			...
			e.printStackTrace();
			takeScreenShot("utilities_neagtive_invalid_details_add_card_message");
		}
	}
