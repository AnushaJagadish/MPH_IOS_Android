...
public class Header_positive_scenario extends Generic_functions{
	...
	public static void verify_alerts_Page() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("header_positive_verify_alerts_Page");
		}
	}
	...
	public static void Help_or_FAQ_page() throws Exception {
		try {
			page_wait(2000);
			...
			e.printStackTrace();
			takeScreenShot("header_positive_Help_or_FAQ_page");
		}
	}
	...
	public static void verify_contact_us() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("header_positive_verify_contact_us");
		}
	}
	...
	public static void verify_dialogue_box() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("header_positive_verify_dialogue_box");
		}
	}
	...
	public static void verify_terms_conditions() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("header_positive_verify_terms_conditions");
		}
	}
	...
	public static void click_feedback() throws Exception {
		if((platformName.equals("Android"))){
			...
			page_wait(1000);
			click("header_positive_click_feedback");
		}		
	}
