...
public class Utilities_positive_scenarios extends Generic_functions {
	...
	public static void navigation_to_pages() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("utilities_positive_navigation_to_pages");
		}	
	}

	/* TC_003 - Add card details  in the Wallet dashboard*/
	...
	public static void click_add_bank() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("utilities_positive_click_add_bank");
		}
	}
	...
	public static void user_on_settings_page() throws Exception {
		try {
			if((platformName.equals("Android"))){			
				click("utilities");
				click("utilities_settings");
			...
			e.printStackTrace();
			takeScreenShot("utilities_positive_user_on_settings_page");
		}			
	}
